      ...
      <DialogContent>
        ...
        <div className='grid grid-cols-12 items-center'>
          ...
          <div className='col-span-6 flex items-center'>
            <img src={product.image} alt={product.name} className='size-16 rounded-md mr-1' />
        ...
        <div className='grid grid-cols-12 items-center'>
          ...
          <div className='col-span-3'>
            <Input value={buyCount} onChange={(e) => setBuyCount(e.target.value)} placeholder='Số lượng' />
          </div>
        </div>
        <div>
