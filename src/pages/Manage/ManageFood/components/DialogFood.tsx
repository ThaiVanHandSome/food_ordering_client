...
export default function DialogFood({ product }: Props) {
  ...
  const updateProductMutation = useMutation({
    mutationFn: ({ id, body }: { id: string; body: ProductRequest }) => updateProduct(id, body)
  })
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>{!isUpdate ? 'Thêm món ăn' : 'Chỉnh sửa món ăn'}</DialogTitle>
        </DialogHeader>
        <Form {...form}>
          <form onSubmit={onSubmit}>
            <div>
              <div className='mb-3'>
                {previewImage && <img src={previewImage} alt={product?.name} className='size-36 rounded-lg mb-3' />}
              ...
              <div className='grid grid-cols-12 mb-3'>
                ...
                <div className='col-span-8'>
                  <InputCustom control={form.control} name='name' placeholder='Tên' className='mb-0' />
                </div>
              </div>
              <div className='grid grid-cols-12 mb-3'>
              ...
              <div className='grid grid-cols-12 mb-3'>
                ...
                <div className='col-span-8'>
                  <InputCustom control={form.control} name='description' placeholder='Mô tả' className='mb-0' />
                </div>
              </div>
              <div className='grid grid-cols-12 mb-3'>
                <div className='col-span-4'>Giá</div>
                <div className='col-span-8'>
                  <InputCustom control={form.control} name='price' placeholder='Giá' className='mb-0' />
                </div>
              </div>
              <div className='grid grid-cols-12 mb-3'>
