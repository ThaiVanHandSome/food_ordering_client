...
export default function ManageFood() {
  ...
  return (
    <div>
        ...
        <Form {...form}>
          <form>
            <div className='grid grid-cols-12 gap-4'>
              ...
              <div className='col-span-3'>
                <InputCustom control={form.control} name='name' placeholder='Nhập tên để tìm kiếm' label='Tên món ăn' />
              </div>
            </div>
          </form>
        </Form>
      ...
      {products?.data.data.content && <FoodTable products={products?.data.data.content} />}
      <div>
        <Paginate
